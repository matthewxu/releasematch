...
| [**16-页面信息与表字段对照.md**](./16-页面信息与表字段对照.md) | **页面区块 ↔ 表字段 ↔ 写入脚本 ↔ 生成模块**（工程对照） |
...
| [06-run-cli使用说明.md](./06-run-cli使用说明.md) | **workflow.run 总控**（含 **`ops serve`**：页面台账 / **⑥ 日常运营** / **⑤ 配置·跟踪 JS·Jackett** / `ops tmdb-sync` / 配置热加载；**操作旁 ?** 见 `ops-help.js`） |
...
| [**18-竞品击败方案.md**](./18-竞品击败方案.md) | **对标 YTS / 1337x / TPB / Lime / EXT**：战场划分、差距矩阵、四阶段、90 天清单、「打败」三阶定义 |
